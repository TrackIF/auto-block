    ...
    describe('.start', () => {
      it('called once', (done) => {
        ...
        controller.done = (err, response) => {
          ...
          expect(logging).to.be.calledWith(controller.event, controller.context)
    ...
    describe('.success', () => {
      it('called once', (done) => {
        ...
        controller.done = (err, response) => {
          ...
          expect(logging).to.be.calledOnce
          expect(logging).to.be.calledWith('two', controller.context)
    ...
    describe('.failure', () => {
      ...
      it('called once if error', (done) => {
        ...
        controller.done = (err, response) => {
          ...
          expect(logging).to.be.calledOnce
          expect(logging).to.be.calledWith(sampleError, controller.context)
    ...
    describe('.startStep', () => {
      it('called once per step', (done) => {
        ...
        controller.done = (err, response) => {
          ...
          expect(logging).to.be.calledWith('one', controller.context)
          expect(logging).to.be.calledWith('two', controller.context)
