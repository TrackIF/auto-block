...
describe('feeds-lambda-helpers/controllers.js', () => {
  var sandbox
  ...
  describe('handler options', () => {
    describe('.done', () => {
      it('called', (done) => {
        ...
        controllers.lambdaHandler(handler)
      })
      ...
      it('prefers context.done over parameter', (done) => {
        ...
        controllers.lambdaHandler(handler, other)
      })
      ...
      it('falls back to parameter', (done) => {
        ...
        controllers.lambdaHandler(handler, final)
      })
    })
